var args               = arguments[0] || {},
    ...
    pagingControlBg    = args['pagingControlBackgroundColor'] || 'transparent';
...
exports.resetViews=function(views){
	$.scrollableView.setViews(views);
	exports.setCurrentPage(0);
};

exports.intervalViews=function(){
	var i=0;
	setInterval(function(){
		i++;
		if(i==$.scrollableView.views.length){
			i=0;
		}
		$.scrollableView.scrollToView(i);
		exports.setCurrentPage(i);
	},3000);
};
