...
var file = String(Ti.Filesystem.getFile(Ti.Filesystem.resourcesDirectory, "etc/index.html").read());
// get the pdf location
var pdf = Ti.Filesystem.getFile(Ti.Filesystem.resourcesDirectory, "etc/pdf.pdf");
